...
import { Category, CategoryWithProducts, createCategoryType } from "./types";
...
async function createCategory(data: createCategoryType): Promise< IError | ISuccess<Category> > {
